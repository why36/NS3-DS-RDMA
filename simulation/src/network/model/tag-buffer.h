...
class TagBuffer {
   public:
    ...
    void SetMCurrent(uint8_t *_m_current);
    void SetMEnd(uint8_t *_m_end);
    uint8_t *GetMCurrent();
    uint8_t *GetMEnd();
...
uint16_t TagBuffer::ReadU16(void) {
...
uint32_t TagBuffer::ReadU32(void) {
    uint8_t byte0 = ReadU8();
    uint8_t byte1 = ReadU8();
